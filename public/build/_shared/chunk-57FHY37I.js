...
function u(e2, t2) {
  var r2, n2, o2, a2, i3 = { label: 0, sent: function() {
    if (1 & o2[0])
      throw o2[1];
    return o2[1];
  }, trys: [], ops: [] };
          ...
          try {
            ...
            switch (n2 = 0, o2 && (a4 = [2 & a4[0], o2.value]), a4[0]) {
              ...
              case 1:
                ...
                break;
              case 4:
                return i3.label++, { value: a4[1], done: false };
              case 5:
                i3.label++, n2 = a4[1], a4 = [0];
                continue;
              case 7:
                a4 = i3.ops.pop(), i3.trys.pop();
                continue;
              default:
                if (!(o2 = i3.trys, (o2 = o2.length > 0 && o2[o2.length - 1]) || 6 !== a4[0] && 2 !== a4[0])) {
                  i3 = 0;
                  continue;
                }
                ...
                if (6 === a4[0] && i3.label < o2[1]) {
                  i3.label = o2[1], o2 = a4;
                  break;
                }
                if (o2 && i3.label < o2[2]) {
                  i3.label = o2[2], i3.ops.push(a4);
                  break;
                }
...
function f(e2, t2, r2, n2, o2) {
  ...
  return i2(this, void 0, void 0, function() {
    var i3, f3, h2, y2, v2, b2;
    return u(this, function(u2) {
      switch (u2.label) {
        case 0:
          u2.trys.push([0, 12, 13, 14]), i3 = c(a2), f3 = i3.next(), u2.label = 1;
        case 1:
          if (f3.done)
            return [3, 11];
        ...
        case 13:
          try {
            f3 && !f3.done && (b2 = i3.return) && b2.call(i3);
          } finally {
            if (v2)
              throw v2.error;
          }
...
function d(e2, t2, r2, n2, o2, a2) {
  return i2(this, void 0, void 0, function() {
    ...
    return u(this, function(u2) {
      switch (u2.label) {
        case 0:
          return i3 = e2.textContent || "", c2 = function(e3, t3) {
            var r3 = l(t3).slice(0);
            return s(s([], l(e3), false), [NaN], false).findIndex(function(e4, t4) {
              return r3[t4] !== e4;
            });
          }(i3, r2), [4, h(e2, s(s([], l(v(i3, t2, c2)), false), l(y(r2, t2, c2)), false), n2, o2, a2)];
        case 1:
          return u2.sent(), [2];
      }
    });
...
function h(e2, t2, r2, n2, o2) {
  return i2(this, void 0, void 0, function() {
    var a2, i3, s2, f2, d2, h2, y2, v2, b2, m2, w, g, x;
    return u(this, function(S) {
      switch (S.label) {
        case 0:
          if (a2 = t2, o2) {
            for (i3 = 0, s2 = 1; s2 < t2.length; s2++)
              if (f2 = l([t2[s2 - 1], t2[s2]], 2), d2 = f2[0], (h2 = f2[1]).length > d2.length || "" === h2) {
                i3 = s2;
                break;
              }
            a2 = t2.slice(i3, t2.length);
          }
          S.label = 1;
        case 1:
          S.trys.push([1, 6, 7, 8]), y2 = c(function(e3) {
            var t3, r3, n3, o3, a3, i4, l2;
            return u(this, function(s3) {
              switch (s3.label) {
                ...
                case 5:
                  return [3, 8];
                case 6:
                  return a3 = s3.sent(), i4 = { error: a3 }, [3, 8];
                case 7:
                  try {
        ...
        case 2:
          return v2.done ? [3, 5] : (b2 = v2.value, m2 = "WRITING" === b2.opCode(e2) ? r2 + r2 * (Math.random() - 0.5) : n2 + n2 * (Math.random() - 0.5), b2.op(e2), [4, p2(m2)]);
        case 3:
          S.sent(), S.label = 4;
        case 4:
...
var m = (0, import_react.memo)((0, import_react.forwardRef)(function(o2, a2) {
  var i3 = o2.sequence, u2 = o2.repeat, c2 = o2.className, d2 = o2.speed, p3 = void 0 === d2 ? 40 : d2, h2 = o2.deletionSpeed, y2 = o2.omitDeletionAnimation, v2 = void 0 !== y2 && y2, m2 = o2.preRenderFirstString, w = void 0 !== m2 && m2, g = o2.wrapper, x = void 0 === g ? "span" : g, S = o2.splitter, E = void 0 === S ? function(e2) {
    return s([], l(e2), false);
  ...
  j = c2 ? "".concat(k ? Q + " " : "").concat(c2) : k ? Q : "", I = (0, import_react.useRef)(function() {
    var e2, t2 = i3;
    u2 === 1 / 0 ? e2 = f : "number" == typeof u2 && (t2 = Array(1 + u2).fill(i3).flat());
  ...
  var W = x, L = w ? i3.find(function(e2) {
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1747543677768.357";
}
function Header({
  ogImage
}) {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(p, { gap: "4", align: "center", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(i, { src: "../avatar.jpg", fallback: "A", size: "7", alt: PERSITE_SOURCE_default.fullName }, void 0, false, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("h1", { style: {
        fontSize: "2.5rem",
        margin: "0"
      }, children: PERSITE_SOURCE_default.fullName }, void 0, false, {
        fileName: "app/components/Header/index.tsx",
        lineNumber: 30,
        columnNumber: 9
      }, this),
      ogImage ? /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("h2", { style: {
        fontSize: "1.5rem",
        margin: "0"
      }, children: "Freelancer & Indie Hacker" }, void 0, false, {
        fileName: "app/components/Header/index.tsx",
        lineNumber: 34,
        columnNumber: 20
        ...
        "A",
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(m, { speed: 2, repeat: Infinity, sequence: PERSITE_SOURCE_default.headerSection.typeAnimationSequence }, void 0, false, {
          fileName: "app/components/Header/index.tsx",
          lineNumber: 40,
          columnNumber: 12
        }, this)
...
//# sourceMappingURL=/build/_shared/chunk-57FHY37I.js.map
